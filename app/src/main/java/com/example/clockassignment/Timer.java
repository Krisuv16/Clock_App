...
public class Timer extends AppCompatActivity {
    ...
    private ImageButton mButtonStartPause, mButtonReset;
    private CountDownTimer mCountDownTimer;
    private boolean mTimerRunning;
    private long mStartTimeInMillis,mTimeLeftInMillis,mEndTime = 0L;
    @Override
    ...
    private void updateWatchInterface() {
        if (mTimerRunning) {
            ...
            mButtonStartPause.setImageDrawable(getResources().getDrawable(R.drawable.stop_arrow));
        } else {
            mEditTextInput.setVisibility(View.VISIBLE);
            mButtonSet.setVisibility(View.VISIBLE);
            mButtonStartPause.setImageDrawable(getResources().getDrawable(R.drawable.play_arrow));
